...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const html = String.raw`<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
                                  ...
                                  <td>
                                    <div
                                      ...
                                      <p style="margin:0;padding:0">
                                        Workshop date &amp; time drops live on
                                        Monday. Subscribe to get notified the
                                        moment we go live.
                                      </p>
                                    </div>
                                    <table
                                            ...
                                            <table
                                              ...
                                              <tbody>
                                                      ...
                                                      <tbody>
                                                        <tr
                                                          ...
                                                          <td
                                                            ...
                                                            style="margin:0;padding:10px 24px">
                                                            <p
                                                              style="margin:0;padding:0;font-size:11px">
                                                              <span
                                                                style="color:#999999"
                                                                ><span
                                                ...
                                                <tr style="margin:0;padding:0">
                                                  <td
                                                    ...
                                                    <p
                                                      ...
                                                      The workshop date and time
                                                      is set to be announced on
                                                      my livestream in YouTube
                                                      at 7 PM, Tuesday 26 May.
                                                    </p>
                                                  </td>
                                                </tr>
                                                <tr style="margin:0;padding:0">
                                                ...
                                                <tr style="margin:0;padding:0">
                                                  <td
                                                    data-id="__react-email-column"
                                                    style="margin:0;padding:40px 0 0 0">
                                                    <table
                                                      width="100%"
                                                      border="0"
                                                      cellpadding="0"
